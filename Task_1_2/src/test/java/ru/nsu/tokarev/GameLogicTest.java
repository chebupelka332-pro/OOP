...
class GameLogicTest {
    ...
    void testPlayerGetsBlackjack() throws Exception {
        ...
        assertTrue(output.contains("Блэкджек! Вы выиграли раунд!"), "Игра должна определить блэкджек у игрока.");
    }
    ...
    void testPlayerHitsAndBusts() throws Exception {
        ...
        Deck fakeDeck = new Deck() {
            ...
            @Override public Card deal() { return cardQueue.poll(); }
        };
        ...
        String output = outContent.toString();
        assertTrue(output.contains("Перебор! Вы проиграли раунд."), "Игра должна зафиксировать перебор у игрока.");
    }
}